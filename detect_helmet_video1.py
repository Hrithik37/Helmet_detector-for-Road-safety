...
while True:
	...
	for (box, pred) in zip(locs, preds):
		...
		label = "Not_wearing_helmet" if Not_wearing_helmet > Wearing_helmet else "Wearing_helmet"
		color = (0, 0, 255) if label == "Not_wearing_helmet" else (0, 255, 0)

		# include the probability in the label
		label = "{}: {:.2f}%".format(label, max(Wearing_helmet, Not_wearing_helmet) * 100)
